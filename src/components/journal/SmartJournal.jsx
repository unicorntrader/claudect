    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow overflow-x-auto">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {trades.length === 0 && (
              <tr>
                <td colSpan={7} className="text-center py-8 text-gray-500">No trades yet — import history or plan a trade.</td>
              </tr>
            )}
      ...
      {selectedTrade && (
        <div className="bg-white rounded-lg shadow p-6 relative">
          ...
          <h2 className="text-lg font-semibold mb-4">Plan vs Reality — {selectedTrade.symbol}</h2>
